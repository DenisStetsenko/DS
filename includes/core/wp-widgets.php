...
if ( ! function_exists( 'wp_custom_theme_widgets_init' ) ) {
	function wp_custom_theme_widgets_init() {
		...
		register_sidebar( array(
			...
			'before_widget' => '<aside id="%1$s" role="region" aria-label="Sidebar Element" class="widget border bg-white %2$s">',
			'after_widget'  => '</aside>',
		...
		register_sidebar( array(
			...
			'before_widget' => '<aside id="%1$s" role="region" aria-label="Sidebar Element" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h3 class="w-title">',
			'after_title'   => '</h3>',
		) );
		...
		register_sidebar( array(
			...
			'before_widget' => '<aside id="%1$s" role="region" aria-label="Sidebar Element" class="widget rounded-3 font-secondary bg-light-gray border fs-4 %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h3 class="w-title">',
			'after_title'   => '</h3>',
		) );
