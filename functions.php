  ...
  function wp_custom_scripts_and_styles(){
    ...
    if ( is_home() || is_archive() ) :
      ...
      wp_localize_script( 'ajax-pagination', 'ajaxPagination', array(
		...
		if ( is_singular('post') ) :
			wp_enqueue_script( 'gumshoe', 'https://cdnjs.cloudflare.com/ajax/libs/gumshoe/5.1.1/gumshoe.min.js', array(), null, array( 'in_footer' => true, 'strategy'  => 'defer' ) );
			...
			wp_enqueue_script('fancybox', 'https://cdnjs.cloudflare.com/ajax/libs/fancyapps-ui/4.0.31/fancybox.umd.min.js', array(), null, array( 'in_footer' => true, 'strategy'  => 'defer' ) );
    ...
    wp_enqueue_script( 'bootstrap', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.1/js/bootstrap.min.js', array('jquery'), null, array( 'in_footer' => true, 'strategy'  => 'defer' ) );
    ...
    wp_enqueue_style( 'main-min', get_theme_file_uri('assets/styles/css/main.min.css'), array(), wp_get_theme()->get( 'Version' ) );
  }
}
...
/**
 * Manually Define Site Name for Google
 * @return void
